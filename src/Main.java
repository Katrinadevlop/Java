...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Сделка: " + deal[0].getComment() + " разницу доходов и расходов, которая была на момент старта уплаты налогов: " + company2.applyDeals(deal));
        System.out.println("Сделка: " + deal[1].getComment() + " разницу доходов и расходов, которая была на момент старта уплаты налогов: " + company2.applyDeals(deal));
    }
}
